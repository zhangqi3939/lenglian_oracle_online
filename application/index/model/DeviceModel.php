...
//        }
    ...
    public function getBoxData($box_id,$startTime,$endTime,$select='',$forceValid=0,$order_by='INSERT_TIME desc'){
        ...
        if($startTime <=0 && $endTime <=0){
            ...
            $where .= " and (BOX_ID = $box_id)";
            //$sql = "SELECT   BOX_ID,LONGITUDE,LATITUDE,GPS_HUMI,GPS_TEMP1,GPS_TEMP2,GPS_TEMP3,GPS_OIL_LEVEL,RESERVE5 AS GPS_CO2,SPEED,RESERVE6 AS DIRECTION,GPS_DOOR1,GPS_VOLTAGE,COOLER_OFF_FLAG,COOLER_OIL_LEVEL,COOLER_VOLTAGE,COOLER_RPM,AMBIENT_TEMP,RE_AIR_TEMP,OUT_AIR_TEMP,COOLER_SET_TEMP,OIL_TEMP,ZONE_ALARM_CODE,ZONE_STATUS,INSERT_TIME,GPS_TIME,RESERVE3,RESERVE7,COOLER_ALARM_CNT,COOLER_ALARM_VALUE1,COOLER_ALARM_VALUE2,COOLER_ALARM_VALUE3,COOLER_ALARM_VALUE4,COOLER_ALARM_VALUE5,COOLER_ALARM_VALUE6,COOLER_ALARM_VALUE7,COOLER_ALARM_VALUE8,COOLER_ALARM_VALUE9,COOLER_ALARM_VALUE10,COOLER_ALARM_VALUE11,COOLER_ALARM_VALUE12,COOLER_ALARM_VALUE13 FROM zj_data WHERE  BOX_ID = 41812008  AND (  1=1  ) and rownum <100 ORDER BY INSERT_TIME DESC";
            $sql = "SELECT   BOX_ID,LONGITUDE,LATITUDE,GPS_HUMI,GPS_TEMP1,GPS_TEMP2,GPS_TEMP3,GPS_OIL_LEVEL,RESERVE5 AS GPS_CO2,SPEED,RESERVE6 AS DIRECTION,GPS_DOOR1,GPS_VOLTAGE,COOLER_OFF_FLAG,COOLER_OIL_LEVEL,COOLER_VOLTAGE,COOLER_RPM,AMBIENT_TEMP,RE_AIR_TEMP,OUT_AIR_TEMP,COOLER_SET_TEMP,OIL_TEMP,ZONE_ALARM_CODE,ZONE_STATUS,INSERT_TIME,GPS_TIME,RESERVE3,RESERVE7,COOLER_ALARM_CNT,COOLER_ALARM_VALUE1,COOLER_ALARM_VALUE2,COOLER_ALARM_VALUE3,COOLER_ALARM_VALUE4,COOLER_ALARM_VALUE5,COOLER_ALARM_VALUE6,COOLER_ALARM_VALUE7,COOLER_ALARM_VALUE8,COOLER_ALARM_VALUE9,COOLER_ALARM_VALUE10,COOLER_ALARM_VALUE11,COOLER_ALARM_VALUE12,COOLER_ALARM_VALUE13 FROM zj_data WHERE  $where and rownum <100 ORDER BY INSERT_TIME DESC";
            $res = Db::query($sql);
            return $res;
        }else{
            if(!empty($forceValid)){
            ...
            $where .= " and (BOX_ID = $box_id)";
            $where .= "and (INSERT_TIME between $startTime and $endTime)";
            $sql = "SELECT   BOX_ID,LONGITUDE,LATITUDE,GPS_HUMI,GPS_TEMP1,GPS_TEMP2,GPS_TEMP3,GPS_OIL_LEVEL,RESERVE5 AS GPS_CO2,SPEED,RESERVE6 AS DIRECTION,GPS_DOOR1,GPS_VOLTAGE,COOLER_OFF_FLAG,COOLER_OIL_LEVEL,COOLER_VOLTAGE,COOLER_RPM,AMBIENT_TEMP,RE_AIR_TEMP,OUT_AIR_TEMP,COOLER_SET_TEMP,OIL_TEMP,ZONE_ALARM_CODE,ZONE_STATUS,INSERT_TIME,GPS_TIME,RESERVE3,RESERVE7,COOLER_ALARM_CNT,COOLER_ALARM_VALUE1,COOLER_ALARM_VALUE2,COOLER_ALARM_VALUE3,COOLER_ALARM_VALUE4,COOLER_ALARM_VALUE5,COOLER_ALARM_VALUE6,COOLER_ALARM_VALUE7,COOLER_ALARM_VALUE8,COOLER_ALARM_VALUE9,COOLER_ALARM_VALUE10,COOLER_ALARM_VALUE11,COOLER_ALARM_VALUE12,COOLER_ALARM_VALUE13 FROM zj_data WHERE  $where and rownum <100 ORDER BY INSERT_TIME DESC";
            $res = Db::query($sql);
            return $res;
        }
    ...
    public function getBoxData_page($box_id,$startTime,$endTime,$page=1,$perPage=10,$select,$forceValid=0,$order_by='INSERT_TIME desc'){
        ...
        if($startTime <=0 && $endTime <=0){
            ...
            $dataList = Db::name('data')->field($select)->where('BOX_ID',$box_id)->fetchSql(true)->where("INSERT_TIME between $startTime and $endTime")->where($where)->order($order_by)->limit($perPage,$offset)->select();
            dump($dataList);die;
